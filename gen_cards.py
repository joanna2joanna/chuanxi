...
BODY_STREAM = [
  ...
  ('h2', '高原的秩序'),
  ('lead', '海拔决定秩序。'),
  ('p', '进川西之前，需要先对海拔常识有所了解。<strong>3000米是一道门槛</strong>，多数人的高反从这里开始。行程按海拔安排，不按景点安排：一天的路程控制在两三小时山路，下午留出空当看天，天气不对就提前收车。景点不会消失，路况和天气才是当天的变量。'),
