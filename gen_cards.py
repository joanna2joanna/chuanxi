...
BODY_STREAM = [
  ...
  ('lead', '认得出前兆，才躲得开险情。'),
  ('h3', '路上的险'),
  ('p', '川西的雨集中在6到8月，暴雨后一两天不要进峡谷、溪沟。溪水突然变浑、暴涨，沟里传来轰隆声，都是前兆，撤到两侧山坡高处，不要顺沟往下。路上遇塌方，停车观察，掉头绕行，不要硬冲。大雪后不要急着进山，遇雪崩往两侧跑，找岩石或大树躲身后。行车遇地震，减速靠边停到开阔地，避开山崖、桥梁、隧道口和电线杆，停稳后待在车里。震后余震、落石都可能，不要急着走，先观察山体动静。山野的险还不止这些：蛇虫、野兽，还有人。蛇虫路段当心脚下，野狗不招惹，遇熊绕开。财物不外露，不轻信搭讪，记住无痕山野，不留下痕迹，也不惊扰草木兽类。'),
  ('h3', '山野的险'),
  ('p', '夏季午后，高海拔垭口常有雷雨，垭口和山顶不要当避雷处，下午早点下山。湿冷加大风，夏天也会失温，包里带件干衣服，淋湿就换干净。雨后林间、溪边、草丛，蚂蟥多，扎紧裤脚，被咬撒盐让它松口。毒蛇雨后初晴出没，遇蛇慢慢退开，不跑不追赶。被咬记下蛇的样子，尽快就医。'),
  ('h2', '信仰的世界'),
  ('lead', '看墙色，分辨教派。'),
