...
BODY_STREAM = [
  ...
  ('p', '川西开车，大货车多，牧民的牛羊也多，互相让一让。弯道不超车。遇牦牛、羊挡路，减速停车，不鸣笛、不闪灯，等它们自己走开。<strong>让路是川西自驾的默认礼节</strong>。'),
  ('p', '高原开车有两个隐性风险。长下坡一直踩刹车会热衰减，要用低挡位和发动机制动；超车动力衰减，要留出比平原长得多的余量。冰雪路面上，四驱也一样打滑，<strong>慢才是安全</strong>。'),
  ('p', '手机信号在县城和景区都有，支线基本没有。<strong>离开主路之前，给家人或朋友发一个位置</strong>，让他们知道人在哪。进了支线，信号就断了，按没信号准备。应急手段：中国电信有手机直连卫星业务，华为、小米等部分手机开通后，不换卡不换号就能在无信号区通话、发定位；雅安318自驾大本营有全国首个城市卫星服务站，可以租天通卫星设备，按天十元左右。'),
  ('h3', '加油'),
