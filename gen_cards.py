...
PAGE1 = [
  ...
  ('meta', '我习惯在行前把零碎信息整理成笔记，当作出行线索。笔记更新于2026年8月18日。天气、封路、营业时间等信息随季节变化，出发前应再次查询官方信息。'),
  ('h2', '开篇\u3000六章速览'),
  ('keys', KEYS),
]
...
BODY_STREAM = [
  ...
  ('p', '补给认准县城。<strong>进县城加满油</strong>，一离开县城就默认补给消失，往深处走，一律当天往返。离线地图出发前下好，<strong>自救物资可以不用，但不能没有</strong>。冬季走，车上常备防滑链。'),
  ('h2', '山河的地图'),
  ...
  ('h2', '信仰的世界'),
  ('lead', '看墙色，认教派。'),
  ('p', '川西在藏文化版图里的位置。藏区习惯分成三大块：拉萨一带的卫藏，青海甘肃的安多，还有以甘孜、昌都为核心的康巴。康巴人性格外放，「康巴汉子」的名声就是这么来的。和卫藏、安多不同，川西<strong>没有哪个教派一家独大</strong>。甘孜州登记的寺院有515座，宁玛、格鲁、萨迦、噶举、苯教五大教派齐全，其中四大派属藏传佛教，苯教是本土宗教，哪个都占不到一半。'),
  ('p', '认教派，看寺庙外墙的颜色。宁玛派叫<strong>红教</strong>，是最古老的派别，多随牧区分布。萨迦派叫<strong>花教</strong>，寺墙刷红、白、黑三色条纹，据说是文殊、观音、金刚手三位菩萨的象征。噶举派叫<strong>白教</strong>，叫法来自早期僧人穿白衣的传承，四川藏区的祖寺是德格的八邦寺。格鲁派叫<strong>黄教</strong>，传入最晚，理塘的长青春科尔寺是康区最早的格鲁派寺院。还有苯教，比藏传佛教更古老的本地信仰，没有对应的颜色称呼，它在川西的地位比在西藏老家还高，阿坝县的郎依寺，是国内外现存规模最大的苯教寺院，阿坝金川的雍忠拉顶寺一带被称为「第二象雄」。'),
  ...
  ('p', '三大佛学院里，亚青寺最出名的是觉姆岛。它在白玉县昌台草原，1985年由阿秋仁波切创建，是宁玛派的修行地。昌曲河绕寺流过，把女众修行区围成一座河心岛，就是「觉姆岛」，岛上密布上万间绛红色小木屋，住的是觉姆，也就是藏地的女性出家人。屋子是她们自己伐木、夯土、一钉一板搭起来的，每间不足十平方米，屋顶压着塑料布和泥土。<strong>男性三岁以上不上觉姆岛</strong>，岛外的男众不过桥。每年入冬，觉姆们钻进一间仅容一人的小屋，百日闭关，黄昏后才走出。山坡上立着一尊巨大的<span class="nowrap">莲花生大师金像。</span>'),
  ('h2', '手艺的文明'),
  ('lead', '还在挣钱的传承，才是活传承。'),
  ...
  ('p', '壤塘在阿坝州，藏语意思是「财神居住的地方」，核心是觉囊文化。2010年建起第一个觉囊唐卡传习所，<strong>免费教贫困家庭的青少年，一学六到八年</strong>。现在有20多个传习所、3项国家级非遗，壤巴拉非遗传习创业园8万多平方米，聚集唐卡、藏医药、藏陶、藏毯等16类手艺，2024年产值两千多万元。县里还在北京、上海、成都、深圳设了传习基地，60名学员接过故宫藏品唐卡复制的项目。觉囊唐卡工坊进了全国「非遗工坊典型案例」。唐卡的颜色从矿石里磨出来：蓝用青金石，红用朱砂，绿用孔雀石，金是真金箔。矿物不含有机成分，见光不褪色，<strong>一张唐卡放几百年也不变样</strong>。'),
