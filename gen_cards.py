...
BODY_STREAM = [
  ...
  ('p', '<strong>买东西。</strong> 讲好价就认，不反复缠价。看上了再还价，不想要就别乱压价，压完不买最伤和气。'),
  ('p', '<strong>拍照。</strong> 拍人先问，拍寺院内部和法会先看有没有禁令，天葬禁区一次都不要靠近。相机镜头对着人的时候，先问一句，多数人会同意的。'),
  ('p', '这几条记住，路上能少很多误会。'),
  ...
  ('p', '选窗口期。<strong>5到6月、9到10月中是全年最稳的时段</strong>。雨季6到8月以夜雨为主，白天多数能走。冬季也能走，但救援半径长，一台车陷在无人垭口，代价远超省下的时间。'),
  ('p', '高反怎么防。从低到高慢慢爬，头两天别直接上3500米以上过夜。氧气不足的典型信号是头痛、睡不着、没胃口，多数人两三天能适应。乙酰唑胺要遵医嘱提前吃，布洛芬缓解头痛，红景天提前一周吃，只作辅助。备一个指夹式血氧仪，<strong>血氧掉到90%以下就停下来别硬撑</strong>。夜里头痛加重、白天精神很差、走路发飘，是危险信号，赶紧撤到低海拔。'),
  ('p', '补给认准县城。<strong>进县城就把油加满</strong>，一离开县城就默认补给消失，越往深处走，越要当天往返。'),
  ('p', '出发前把离线地图下好，<strong>自救物资可以不用，但不能没有</strong>。冬季走，车上常备防滑链。'),

  ('h2', '二　山河的地图'),
  ('lead', '山河决定地图。山脉怎么切，路就怎么修。'),
  ('p', '先看川西怎么来的。约4000万到5000万年前，印度板块撞上欧亚板块，把一片浅海抬成陆地，就是青藏高原，川西在高原的东南缘。碰撞到现在没停，高原还在缓慢升高，这也是川西地震多的原因。'),
  ('p', '山脉全是南北走向。横断山把川西切成一列列山岭，从东往西：邛崃山，四姑娘山在主脊上；大雪山，<strong>贡嘎山海拔7508.9米，蜀山之王</strong>；沙鲁里山；雀儿山。山与山之间夹着河谷，路顺着河谷修，镇子落在河谷里。川西的聚落跟着山河走，不跟着行政区划走。'),
  ('p', '河流往三处去。东部是大渡河，小金、金川、丹巴都在它的水系里；雅砻江从甘孜县城边流过；金沙江是德格的西界，德格县城在金沙江东岸。<strong>三条江在横断山南部并流，就是地理上的三江并流</strong>。'),
  ('p', '海子是古冰川留下的湖。冰期冰川刨出的洼地积水成湖，理塘到稻城之间的海子山，古冰川退去后留下<strong>1145个高原湖泊</strong>。单个看，康定的木格措、九龙的伍须海、巴塘的措普湖各有各的颜色，德格雀儿山下的新路海紧挨着雪峰。'),
  ('p', '川西地震多，因为它在<strong>鲜水河断裂带</strong>上。这条断裂带从中部纵贯，历史上强震不断。对旅行者，它意味着两件事：路况随时可能因塌方管制，很多陡崖和河谷的走向，就是断裂带运动的痕迹。'),
  ('p', '植被随海拔分层，从山谷到垭口一路换。2500米以下是针阔混交林；2500到3500米是云杉冷杉的针叶林，高山杜鹃夹在林里，<strong>康定荷花海有1500公顷的高山杜鹃林</strong>，多是百年以上的老林，每年四月底五月初成片开花；3500到4500米是高山灌丛和高山草甸，冬虫夏草、雪茶都长在这一层；4500米以上是流石滩，雪莲贴着碎石长。翻垭口的路上，从针叶林到流石滩，一路换着看。'),
  ('p', '吃的也跟海拔走。青稞是高原的当家作物，炒熟磨成糌粑，拌上酥油茶捏成团，是藏人的日常主食；酥油茶用砖茶和酥油熬，热量高、解渴御寒，当地有<strong>「宁可三日无肉，不可一日无茶」</strong>的说法。牦牛在海拔3500米以上放养，肉干、火锅、炖汤都常见；血肠是待客的上等菜，牛血或羊血和肉丁灌进小肠煮熟。松茸这类菌子长在森林里，集中在金沙江、雅砻江、大渡河上中游的高山峡谷，夏秋下过雨就冒头，炖鸡、涮锅都鲜。这些不用刻意找，路边饭馆的菜单上就有。'),
  ...
  ('h2', '四　信仰的世界'),
  ('lead', '看墙色，认教派。'),
  ('p', '先看川西在藏文化版图里的位置。藏区习惯分成三大块：拉萨一带的卫藏，青海甘肃的安多，还有以甘孜、昌都为核心的康巴。康巴人性格外放，「康巴汉子」的名声就是这么来的。和卫藏、安多不同，川西<strong>没有哪个教派一家独大</strong>。甘孜州515座寺院里，宁玛派220座、格鲁派129座、萨迦派78座、苯教51座、噶举派37座。想把藏传佛教五大教派一次看全，川西是最好的窗口，别处凑不齐。'),
  ('p', '认教派最简单的方法，看寺庙外墙的颜色。宁玛派叫红教，是最古老的派别，多随牧区分布。萨迦派叫花教，寺墙刷红、白、黑三色条纹，据说是文殊、观音、金刚手三位菩萨的象征。噶举派叫白教，叫法来自早期僧人穿白衣的传承，四川藏区的祖寺是德格的八邦寺。格鲁派叫黄教，传入最晚，理塘的长青春科尔寺是四川第一座格鲁派寺院。还有苯教，比藏传佛教更古老的本地信仰，它在川西的地位比在西藏老家还高，<strong>四川的苯教寺庙数量全国第一</strong>，阿坝金川的雍忠拉顶寺一带被称为「第二象雄」。'),
  ('p', '最特别的是德格。历代德格土司推行「不分教派、一律扶持」的政策，硬是把五大教派全留在自家地盘上，这在藏区很少见，<strong>德格也因此成了藏文化的三大中心之一</strong>。印经院1729年建，由萨迦派更庆寺管理，藏了三十多万块木刻经版，是全世界最大的木刻雕版印刷机构。'),
  ('p', '路上的符号，看得懂会很有意思。经幡也叫风马旗，五种颜色对应蓝天、白云、红火、江河、大地，挂在山顶风口，<strong>藏人相信风吹动一次等于诵经一次</strong>。玛尼堆是刻了六字真言的石块堆，路人经过会念着真言添一块石头，别搬走当纪念品。白塔源于古印度的覆钵式佛塔，路过可以捡块石头放上去，或者献条哈达许个愿。转经筒里装着经文，转一圈等于念诵一遍，藏人转经廊、转佛塔、转寺院都是这个逻辑。六字真言「唵嘛呢叭咪吽」是观世音菩萨的总持咒，被看作雪域佛法最根本的念诵。'),
  ('p', '德格县有座佐钦寺，宁玛派的祖寺之一，寺里的<strong>大圆满塔</strong>和尼泊尔加德满都的博达哈大佛塔长得一样。两座塔同源：古印度的覆钵式佛塔。佛陀涅槃后，舍利分装进覆钵形的土冢，这种形制传到尼泊尔，博达哈成了全世界最大的覆钵塔；传到中国内地，13世纪尼泊尔工匠阿尼哥建的北京妙应寺白塔，把藏式瓶形塔的样式定了型。佐钦寺的大圆满塔，用的就是同一套形制。'),
  ('p', '和信仰打交道，分寸比知识重要。<strong>绕行一律顺时针，只有苯教是逆时针</strong>，遇到别懵。磕长头是身敬、语敬、意敬三者合一，额头叩地的瞬间，心里同时念咒、观想，这是他们能磕几千公里的原因。煨桑是烧香柏枝，敬献给神佛的香火，也是祈愿的仪式。献哈达要看对象：白色最普遍，黄色献给活佛和高僧，五彩哈达被视为菩萨的衣裳，只在隆重场合用。哈达只递到对方手里，不能挂脖子上，只有长辈给晚辈才往脖子上搭。天葬是藏人把遗体布施给神鹰，被认为是最高的舍身布施，全程严禁围观、严禁拍照，法律明令禁止，连打听都不要。还有几条硬规矩：不摸别人的头，佛像、唐卡、经书不指，非要指就五指并拢、手心朝上，不进人家供奉的佛堂，不取献给塔上的供品，过门槛不踩。'),
  ...
  ('p', '民居在藏寨之外还有几路。乡城白藏房，2020年评上「中国白藏房文化之乡」，现存约4000栋，土木结构，土墙夯筑，能用上百年，墙体收成梯形，大小以「柱间」计数，一户35到68根柱。传统上是五六层，底层养牲畜，二层住人，上面晒粮，经堂永远在最高处。每年有个「白色灌礼」的民俗，用山上一种白土拌水从墙头浇下来，把墙浇白，既加固又祈福。木雅藏房在康定木雅地区，片石砌筑，外观古朴庄重。羌族的桃坪羌寨在阿坝理县，房子叫「庄房」，全石砌成，<strong>工匠不绘图、不计算，凭经验垒</strong>，石墙一层层向内收分，屋顶平台家家相连，外号「东方神秘古堡」。寨里的羌碉9层、高约30米，经受了1933年叠溪、2008年汶川几次大地震。'),
  ('p', '材料和气候不同，寨子的做法就不同。'),
...
APPENDIX = [
  ('h2', '附录　出发清单、藏语词、官方渠道'),
  ('h3', '出发检查清单'),
  ('list', '<li>证件：身份证、驾驶证、行驶证，随身带好</li>'
  ...
  ('h3', '藏语常用词'),
  ('cwords', '<li><b>扎西德勒</b>吉祥如意，最通用的问候</li>'
             '<li><b>突及其</b>谢谢</li>'
             ...
             '<li><b>嘎地</b>辛苦了</li>'),
  ('h3', '官方渠道'),
  ('list', '<li>路况：阿坝州政府官网「阿坝路况」专栏、四川发布和成都发布公众号</li>'
...
CSS = """
  ...
  *{box-sizing:border-box;margin:0;padding:0;}
  ...
  .card__meta{
    font-family:var(--sans);font-size:22px;line-height:1.7;
