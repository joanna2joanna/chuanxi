...
BODY_STREAM = [
  ('h3', '与人相处'),
  ('p', '<strong>牧民。</strong> 牛羊是牧民的主要家当。遇到牧群，放慢车速、不鸣笛，等它们过。拍牧民和牲畜，先打招呼再举相机。牧场的帐篷和围栏，不随便进去。'),
  ...
  ('h3', '山野的险'),
  ('p', '夏季午后，高海拔垭口常有雷雨，垭口和山顶不要当避雷处，下午早点下山。湿冷加大风，夏天也会失温，包里带件干衣服，淋湿就换干净。雨后林间、溪边、草丛，<strong>蛇虫</strong>多，当心脚下，扎紧裤脚防蚂蟥，被咬撒盐让它松口。毒蛇雨后初晴出没，遇蛇慢慢退开，不跑不追赶，被咬记下蛇的样子，尽快就医。<strong>野狗</strong>不招惹，遇<strong>熊</strong>绕开。财物不外露，不轻信搭讪。记住<strong>无痕山野</strong>，不留下痕迹，也不惊扰草木和飞鸟走兽。'),
  ('h2', '信仰的世界'),
  ('lead', '看墙色，分辨教派。'),
