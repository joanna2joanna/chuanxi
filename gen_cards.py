...
BODY_STREAM = [
  ...
  ('h2', '信仰的世界'),
  ('lead', '看墙色，认教派。'),
  ('p', '川西在藏文化版图里的位置。藏区习惯分成三大块：拉萨一带的卫藏，青海甘肃的安多，还有以甘孜、昌都为核心的康巴。康巴人性格外放，「康巴汉子」的名声就是这么来的。和卫藏、安多不同，川西<strong>没有哪个教派一家独大</strong>。甘孜州登记的寺院有515座，宁玛、格鲁、萨迦、噶举、苯教五大教派齐全，其中四大派属藏传佛教，苯教是本土宗教。'),
