...
BODY_STREAM = [
  ...
  ('h2', '信仰的世界'),
  ('lead', '看墙色，认教派。'),
  ('p', '川西在藏文化版图里的位置。藏区习惯分成三大块：拉萨一带的卫藏，青海甘肃的安多，还有以甘孜、昌都为核心的康巴。康巴人性格外放，「康巴汉子」的名声就是这么来的。和卫藏、安多不同，川西<strong>没有哪个教派一家独大</strong>。甘孜州登记的寺院有515座，宁玛、格鲁、萨迦、噶举四大教派是藏传佛教，本土的苯教不算，五派齐全，哪个都占不到一半。'),
  ('p', '认教派，看寺庙外墙的颜色。宁玛派叫<strong>红教</strong>，是最古老的派别，多随牧区分布。萨迦派叫<strong>花教</strong>，寺墙刷红、白、黑三色条纹，据说是文殊、观音、金刚手三位菩萨的象征。噶举派叫<strong>白教</strong>，叫法来自早期僧人穿白衣的传承，四川藏区的祖寺是德格的八邦寺。格鲁派叫<strong>黄教</strong>，传入最晚，理塘的长青春科尔寺是康区最早的格鲁派寺院。还有苯教，比藏传佛教更古老的本地信仰，没有对应的颜色称呼，它在川西的地位比在西藏老家还高，<strong>阿坝县的郎依寺，是国内外现存规模最大的苯教寺院</strong>，阿坝金川的雍忠拉顶寺一带被称为「第二象雄」。'),
