...
KEYS = ('<ul class="card__keys"><li><span>海拔决定秩序</span><b>一 高原的秩序</b></li> <li><span>山河决定地图</span><b>二 山河的地图</b></li> <li><span>车是腿，慢是快</span><b>三 路上的驾驶学</b></li> <li><span>看墙色认教派</span><b>四 信仰的世界</b></li> <li><span>手艺是还在运转的产业</span><b>五 手艺的文明</b></li> <li><span>材料决定房子</span><b>六 建筑的方言</b></li></ul>')
...
PAGE1 = [
  ...
  ('h2', '开篇\u3000六章速览'),
  ('keys', '<li><span>海拔决定秩序</span><b>一 高原的秩序</b></li> <li><span>山河决定地图</span><b>二 山河的地图</b></li> <li><span>车是腿，慢是快</span><b>三 路上的驾驶学</b></li> <li><span>看墙色认教派</span><b>四 信仰的世界</b></li> <li><span>手艺是还在运转的产业</span><b>五 手艺的文明</b></li> <li><span>材料决定房子</span><b>六 建筑的方言</b></li>'),
]
...
BODY_STREAM = [
  ...
  ('close', '更新于 2026年8月18日。封路、天气、信号等信息随季节变化，出发前以官方信息为准。'),
  ('h2', '高原的秩序'),
  ('lead', '海拔决定秩序。'),
