...
BODY_STREAM = [
  ...
  ('p', '<strong>司机和本地人。</strong> 见面一句“扎西德勒”，气氛就开了。问路、问价，态度客气，多数人都愿意答。高原上的人大多直接，不绕弯。'),
  ...
  ('h2', '高原的秩序'),
  ('lead', '海拔决定秩序。'),
  ('p', '进川西先认海拔。<strong>3000米是一道门槛</strong>，多数人的高反从这里开始。行程按海拔安排，不按景点安排：一天的路程控制在两三小时山路，下午留出空当看天，天气不对就提前收车。景点不会消失，路况和天气才是当天的变量。'),
  ('p', '窗口期。<strong>5到6月、9到10月中是全年最好走的时段</strong>。雨季6到8月以夜雨为主，白天多数能走。冬季也能走，但救援半径长，一台车陷在无人垭口，代价远超省下的时间。'),
  ('p', '防高反。从低到高慢慢爬，头两天不在3500米以上过夜。典型信号是头痛、睡不着、没胃口，多数人两三天能适应。乙酰唑胺遵医嘱提前吃，布洛芬缓解头痛。红景天不能降低高反发生率，只缓解症状。高原低血糖常见，头晕乏力冲杯糖水能缓过来，补的是血糖不是氧。指夹式血氧仪测血氧，高原上血氧比平原低是常态，<strong>掉到85%以下、人也不舒服，就往下撤</strong>。夜里头痛加重、白天精神很差、走路发飘，是危险信号，撤到低海拔。'),
  ('p', '补给认准县城。<strong>进县城加满油</strong>，一离开县城就默认补给消失，越往深处越要当天往返。离线地图出发前下好，<strong>自救物资备足</strong>。冬季自驾，车上常备防滑链。'),
  ('h2', '山河的地图'),
  ...
  ('p', '河流往三处去。东部是大渡河，小金、金川、丹巴都在它的水系里；雅砻江从甘孜县城边流过；金沙江是德格的西界，德格县城在金沙江东岸。三条江分头汇进长江。'),
  ...
  ('lead', '前兆认得出，险情躲得开。'),
  ('h3', '路上的险'),
  ('p', '川西的雨集中在6到8月，暴雨后一两天别进峡谷、溪沟。溪水突然变浑、暴涨，沟里传来轰隆声，都是前兆，往两侧山坡高处跑，别顺着沟跑。路上遇塌方，停车观察，掉头绕行，不硬冲。大雪后别急着进山，遇雪崩往两侧跑，找岩石或大树躲身后。行车时找开阔地停，避开山崖、桥梁、隧道口和电线杆，震后有余震，别急着走。'),
  ('h3', '山野的险'),
  ('p', '夏季午后，高海拔垭口常有雷雨，垭口和山顶别当避雷处，下午早点下山。湿冷加大风，夏天也会失温，包里带件干衣服，淋湿就换。雨后林间、溪边、草丛，蚂蟥多，扎紧裤脚，被咬撒盐让它松口。毒蛇雨后初晴出没，遇蛇慢慢退开，不跑不追。被咬记下蛇的样子，尽快就医。'),
  ('h2', '信仰的世界'),
  ('lead', '看墙色，分辨教派。'),
  ...
  ('p', '和信仰打交道，有几条规矩：<strong>绕行一律顺时针，只有苯教是逆时针</strong>。磕长头是身敬、语敬、意敬三者合一，额头叩地的瞬间，心里同时念咒、观想。煨桑是烧香柏枝，也是祈愿的仪式。献哈达要看对象：白色最普遍，黄色献给活佛和高僧，五彩哈达被视为菩萨的衣裳，只在隆重场合用。<strong>哈达只递到对方手里，不能挂脖子上，只有长辈给晚辈才往脖子上搭</strong>。天葬是藏人把遗体布施给神鹰，<strong>全程严禁围观、拍照，当地有明文规定，连打听都不要</strong>。另有几条硬规矩：<strong>不摸别人的头，佛像、唐卡、经书不指</strong>，非要指就五指并拢、手心朝上，不进人家供奉的佛堂，不取献给塔上的供品，过门槛不踩。'),
