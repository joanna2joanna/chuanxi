...
PAGE1 = [
  ...
  ('meta', '我习惯在行前把零碎信息整理成笔记，当作出行线索。笔记更新于2026年8月28日。天气、封路、营业时间等信息随季节变化，出发前应再次查询官方信息。'),
  ('h2', '开篇\u3000七章速览'),
  ('keys', KEYS),
]
...
BODY_STREAM = [
  ...
  ('p', '<strong>海子是古冰川留下的湖。</strong>冰期冰川刨出的洼地积水成湖，理塘到稻城之间的海子山，古冰川退去后留下1145个高原湖泊。川西各处也能看到这样的湖：康定的木格措、九龙的伍须海、巴塘的措普湖、德格雀儿山下的新路海。伍须海是“仙女梳妆的明镜”，新路海紧挨着雀儿山雪峰。'),
  ...
  ('p', '川西路权的优先级，属于大货车和牧民的牛羊。遇牦牛、羊挡路，减速停车，不鸣笛、不闪灯，等它们自己走开。<strong>让路是川西自驾的默认礼节</strong>。'),
...
APPENDIX = [
  ('h2', '出发清单、藏语词'),
  ('h3', '出发检查清单'),
  ('list', '<li>证件：身份证、驾驶证、行驶证，随身带好</li> <li>药品：乙酰唑胺（遵医嘱）、布洛芬、感冒药、肠胃药、葡萄糖（头晕乏力时冲水喝，补血糖）</li> <li>衣物：抓绒、羽绒、冲锋衣，帽子、墨镜、防晒霜，保温杯</li> <li>装备：指夹式血氧仪、离线地图</li> <li>车：拖车绳、防滑链、充气泵、补胎工具</li>'),
  ('h3', '藏语常用词'),
  ...
  ('h3', '官方渠道'),
  ('cwords', '<li><b>掌上通甘孜</b>小程序和公众号，甘孜州交通运输局官方，实时路况、气象预警、充电桩查询</li> <li><b>一部手机游阿坝</b>小程序和公众号，阿坝州文旅局上线，门票预约、自驾路线、实时客流</li> <li><b>阿坝交通</b>公众号，实时路况与避堵提醒</li>'),
]
