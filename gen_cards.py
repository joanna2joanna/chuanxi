...
A_PAGES = [
  ...
  [
    ('h2', '出发检查清单'),
    ('list', '<li>证件：身份证、驾驶证、行驶证随身带，别放车里</li> <li>车况：出发前保养，查轮胎、备胎、刹车、防冻液、机油</li> <li>油料：进县城就加满，县外默认没有加油站，见油就加</li> <li>脱困：拖车绳、防滑链、充气泵、补胎工具、搭电线</li> <li>电源：充电宝带足，手机全程导航费电，下车关屏</li> <li>高反药：乙酰唑胺遵医嘱提前吃，布洛芬备头痛</li> <li>常备药：感冒、肠胃、晕车、创可贴、葡萄糖冲水喝</li> <li>监测：指夹式血氧仪，头晕无力先测一下</li> <li>衣物：抓绒、羽绒、冲锋衣，进山前全带上</li> <li>防晒：高倍防晒霜、墨镜、帽子、润唇膏</li> <li>饮水：保温杯装热水，车上备干粮、能量零食</li> <li>导航：离线地图出发前下好，支线没有信号</li> <li>预案：把行程告诉家人，山里按没信号准备</li> <li>收尾：垃圾全部带走，不留在山里</li>'),
  ],
  # 附录第2页（17）——路况与预警的官方渠道
  [
    ('h2', '路上的官方渠道'),
